               ...
               <form action="{{route('religions.store')}}" method="POST">
                    ...
                    <div class="row align-items-end">
                         <div class="col-md-3 form-group mb-3">
                              ...
                              @enderror
                              <input type="text" name="name" id="name" class="form-control form-control-sm rounded-0" placeholder="Enter Religion Name" value="{{ old('name') }}"/>
                         </div>
               ...
               <table id="mytable" class="table table-sm table-hover border">
                    ...
                    <tbody>
                         ...
                         <tr id="tablerole_{{$religion->id}}">
                              ...
                              <td>
                                   <a href="javascript:void(0);" class="text-info editform" data-bs-toggle="modal" data-bs-target="#editmodal" data-id="{{$religion->id}}" data-name="{{$religion->name}}" data-status="{{ $religion->status_id }}"><i class="fas fa-pen"></i></a>
                                   <a href="#" class="text-danger ms-2 delete-btns" data-idx="{{$idx}}"><i class="fas fa-trash-alt"></i></a>
                              
                              </td>
                              <form id="formdelete-{{ $idx }}" class="" action="{{route('religions.destroy',$religion->id)}}" method="POST">
                                   @csrf
                                   @method("DELETE")
                              </form>
                         </tr>
                                   ...
                                   <form id="formaction" action="" method="POST">
                                        ...
                                        <div class="row align-items-end">
                                             <div class="col-md-6 form-group mb-3">
                                                  <label for="name">Name <span class="text-danger">*</span></label>
                                                  <input type="text" name="name" id="editname" class="form-control form-control-sm rounded-0" placeholder="Enter religion Name" value="{{ old('name') }}"/>
                                             </div>
