...
<form id="stepform" class="mt-3" action="{{ route('register.storestep1') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Confirm Password" value="{{ old('password-confirmation') }}"/>
